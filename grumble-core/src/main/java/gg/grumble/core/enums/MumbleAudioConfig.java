...
public class MumbleAudioConfig {
	...
	public static final int JITTER_MAX_PLC_FRAMES = 15;
	public static final int JITTER_PREFILL_FRAMES = 11;
	public static final int JITTER_PREFILL_TIMEOUT_MS = JITTER_PREFILL_FRAMES * PLAYBACK_DURATION_MS;
	public static final int JITTER_PREFILL_ABANDON_MS = 2000;
